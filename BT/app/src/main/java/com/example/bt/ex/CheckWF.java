...
public class CheckWF extends AppCompatActivity {
    Switch sw_wifi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_wf);
        callID();
        sw_wifi.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    Toast.makeText(CheckWF.this, "Bạn đã bật wf", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(CheckWF.this, "Bạn đã tắt wf", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        bt_xn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(CheckWF.this, "Bạn đã chọn " + MH, Toast.LENGTH_SHORT).show();
            }
        });
    }
